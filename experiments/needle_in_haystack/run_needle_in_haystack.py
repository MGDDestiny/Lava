...
def config_compress(model, window_size=8, base_capacity=512, kernel_size=7, pooling="maxpool", floor_alpha=0.5, pyram_mode = False, pyram_beta = 20, normalize=True, skip=0, gqa_support=False):
...
class LLMNeedleHaystackTester:
    ...
    def __init__(self,
                 ...
                 haystack_dir="/data/Methods/AdaKV/experiments/data/PaulGrahamEssays", # PaulGrahamEssays  
        ...
        if compress_args is not None:
            self.model = config_compress(self.model, **compress_args)
    ...
    def evaluate_and_log(self, context_length, depth_percent):
        ...
        # prompt = self.enc.apply_chat_template(prompt, tokenize=False, add_generation_prompt=True)
